...
export default function Sidebar({ sidebar_data_path }: { sidebar_data_path: any }) {
        ...
        <aside className="sidebar ">
            {
                data.map((section: any, secIdx: number) => (
                    <div key={`section-${secIdx}`} className="my-4">
                        {section.heading && <p className="heading-alt text-gray-500">{section.heading}</p>}
                                        ...
                                        <div key={`side-link-${linkIdx}`}>
                                            {
                                                link.url ?
                                                    ...
                                                    <a className="sidebar__link sidebar__link--disabled"
